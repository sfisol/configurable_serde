...
/// Arguments passed to the `configurable_serde` attribute macro.
...
/// The main procedural macro function.
#[proc_macro_attribute]
pub fn configurable_serde(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let result = match &mut item {
        ...
        _ => {
            ...
            Err(syn::Error::new_spanned(
                &item,
                "configurable_serde can only be used on structs and enums",
            ))
        }
    };
