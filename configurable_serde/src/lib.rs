...
//!
//! There is also a generator macro provided [`create_config!`], which builds wrapper
...
//! ```
//!
//! Note, that if you want to use your applier across whole project, you need to place [`create_config!`]
//! before any `mod` directives for modules using the applier.
//! This is because `#[macro_export]` term generated by other macro is not recognized early enough.
//!
...
//!
//! This is the same what you get using [`create_config!`] macro, but it let's you to place the definition
